...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    @org.springframework.cache.annotation.Cacheable(value = "users_v3", key = "#usernameOrEmail")
     ...
     */
    @Transactional(readOnly = true)
    @org.springframework.cache.annotation.Cacheable(value = "usersById_v3", key = "#userId")
