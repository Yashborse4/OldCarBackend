package com.carselling.oldcar.service.admin;
...
public class AdminService {
    ...
    public com.carselling.oldcar.dto.admin.AdminDashboardResponse getDashboardResponse() {
        ...
        return com.carselling.oldcar.dto.admin.AdminDashboardResponse.builder()
                ...
                .recentActivity(List.of(
                        Map.of("action", "User Registration", "count",
                                userStats.getNewUsersLast7Days(),
                                "period", "Last 7 days"),
                        Map.of("action", "Cars Listed", "count",
                                carStats.getNewCarsLast7Days(),
                                "period", "Last 7 days"),
                        Map.of("action", "Total Users", "count",
                                userStats.getTotalUsers(), "period",
                                "Current"),
                        Map.of("action", "Total Cars", "count",
                                carStats.getTotalCars(), "period",
                                "Current")))
                .build();
    }
